...
export default function SideNav() {
  ...
  return (
    <>
      ...
      <nav
        id='sidenav-1'
        className="hidden z-50 sm:block fixed left-0 top-0 z-[1035] h-screen w-96 -translate-x-full overflow-hidden bg-gray-100 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
