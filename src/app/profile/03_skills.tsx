    ...
    <div id='skills' className="flex justify-center items-center">
      <div className="block w-full p-6 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-300 dark:border-gray-700 dark:hover:bg-gray-100">
        ...
        < div className="md:mx-10 grid grid-cols-2 gap-4 lg:grid-cols-3" >
          {skillsLogo.map(logo => {
            return (
              <div key={logo.path} className="flex justify-center p-2 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-300 dark:border-gray-700 dark:hover:bg-gray-100">
